...
folderCharacter = "\\"
xmlFolder = "E:\\MicrosoftOneDrive\\OneDrive\\Working\\datasets\\Labeled\\misOffice\\misoffice-head_body_chair\\labels"
imgFolder = "E:\\MicrosoftOneDrive\\OneDrive\\Working\\datasets\\Labeled\\misOffice\\misoffice-head_body_chair\\images"
labelName = "body"
saveROIsPath = "body"
imageKeepType = "jpg"
...
def saveROI( roiSavePath, imgFolder, xmlFilepath, labelGrep=""):
...
for file in os.listdir(xmlFolder):
    ...
    if(file_extension==".xml"):
        ...
        saveROI(saveROIsPath, imgFolder, xmlfile, labelName)
