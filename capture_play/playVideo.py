...
face_size = (48, 48)
monitor_winSize = (600, 600)

face_cascade = cv2.CascadeClassifier('body_48_0703.xml')
...
while(camera.isOpened()):
    ...
    if(grabbed):	
        ...
        putText(img2, str(max(peopleCount))+" peoples", 210, 50, (0,0,255), thickness=3, size=1.3)  
